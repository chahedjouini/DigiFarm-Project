 ...
 */
final class Version20250304082317 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE etude ADD id_user_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE suivi ADD id_user_id INT NOT NULL');
