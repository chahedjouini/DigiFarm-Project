 ...
 */
final class Version20250217124657 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE suivi (id INT AUTO_INCREMENT NOT NULL, id_animal INT DEFAULT NULL, temperature DOUBLE PRECISION DEFAULT NULL, rythme_cardiaque DOUBLE PRECISION DEFAULT NULL, etat VARCHAR(255) NOT NULL, veterinaire VARCHAR(255) NOT NULL, id_client INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
