...
final class MaintenanceController extends AbstractController
{
    ...
    {
        return $this->render('frontOfficeMachine/maintenance/index.html.twig', [
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('frontOfficeMachine/maintenance/new.html.twig', [
    ...
    {
        return $this->render('frontOfficeMachine/maintenance/show.html.twig', [
            'maintenance' => $maintenance,
        ]);
    }
    ...
    public function edit(Request $request, Maintenance $maintenance, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('frontOfficeMachine/maintenance/edit.html.twig', [
            'maintenance' => $maintenance,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('backOfficeMachine/maintenance2/index.html.twig', [
            'maintenances' => $maintenanceRepository->findAll(),
        ]);
    }
    ...
    public function newMaintenance2(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('backOfficeMachine/maintenance2/new.html.twig', [
            'maintenance' => $maintenance,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('backOfficeMachine/maintenance2/show.html.twig', [
            'maintenance' => $maintenance,
        ]);
    }
    ...
    public function editMaintenance2(Request $request, Maintenance $maintenance, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('backOfficeMachine/maintenance2/edit.html.twig', [
            'maintenance' => $maintenance,
            'form' => $form,
        ]);
    }
