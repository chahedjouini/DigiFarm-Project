...
final class MachineController extends AbstractController
{
    ...
    {
        return $this->render('frontOfficeMachine/machine/index.html.twig', [
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('frontOfficeMachine/machine/new.html.twig', [
            'machine' => $machine,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('frontOfficeMachine/machine/show.html.twig', [
            'machine' => $machine,
        ]);
    }
    ...
    public function edit(Request $request, Machine $machine, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('frontOfficeMachine/machine/edit.html.twig', [
            'machine' => $machine,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('backOfficeMachine/machine2/index.html.twig', [
            'machines' => $machineRepository->findAll(),
        ]);
    }
    ...
    public function newMachine2(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('backOfficeMachine/machine2/new.html.twig', [
            'machine' => $machine,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('backOfficeMachine/machine2/show.html.twig', [
            'machine' => $machine,
        ]);
    }
    ...
    public function editMachine2(Request $request, Machine $machine, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('backOfficeMachine/machine2/edit.html.twig', [
            'machine' => $machine,
            'form' => $form,
        ]);
    }
